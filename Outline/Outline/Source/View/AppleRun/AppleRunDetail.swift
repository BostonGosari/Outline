            ...
            ScrollView {
                ZStack(alignment: .top) {
                    ...
                    VStack {
                        ...
                        AppleRunDetailInformationView(
                            showCopyLocationPopup: $showCopyLocationPopup
                        )
